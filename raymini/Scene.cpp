...
void Scene::buildDefaultScene () {
    ...
    Material wallBackMat(0.8f, 0.2f, Vec3Df(1.f, 1.f, 0.f), 1.f) ;
    ...
    Material sphereMat (1.0f, 0.2f, Vec3Df (1.f, 1.f, 1.f), 1.f);
    Object sphere (sphereMesh, sphereMat);
    sphere.setTrans (Vec3Df (0.f, 0.f, 2.f));
    objects.push_back (sphere);
    */
    for (unsigned int i = 0; i < objects.size(); i++)
		objects[i].getMesh().buildKdTree();

    Light l1 (Vec3Df (0.0f, -5.0f, 3.0f), Vec3Df (1.0f, 1.0f, 1.0f), 1.0f, 1.0f);
    lights.push_back (l1);
    Light l2 (Vec3Df (0.0f, 0.0f, 5.0f), Vec3Df (1.0f, 1.0f, 1.0f), 1.0f, 1.0f);
    lights.push_back (l1);
}
